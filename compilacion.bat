...
cl /nologo /Zi /GR- /EHs /MD main.cc -I ".\Lib_Graph\ESAT_rev225\include" ".\Lib_Graph\ESAT_rev225\bin\ESAT.lib"   opengl32.lib user32.lib gdi32.lib shell32.lib Ws2_32.lib
